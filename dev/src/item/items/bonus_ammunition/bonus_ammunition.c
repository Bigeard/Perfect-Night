...
void DrawItemBonusAmmunition(Item *item)
{
    ...
    for (int a = 0; a < player.ammunition; a++)
    {
        ...
        DrawCircle(ammunitionPosX, ammunitionPosY, 5.0f, LerpColor(themeColor[item->bonusAmmunition.idColorA], themeColor[item->bonusAmmunition.idColorB], item->bonusAmmunition.animationTimer));
    }
